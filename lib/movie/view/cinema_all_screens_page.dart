...
import 'package:movieapp/movie/view/seat_arrangement_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          context: context,
          topText: "The King's Man",
          bottomText: "In Theaters December, 2021",
        ),
      ),
