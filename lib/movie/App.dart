...
import 'package:movieapp/movie/utility/constants.dart';
import 'package:movieapp/movie/view/main_page.dart';
import 'package:movieapp/movie/view/result_found_page.dart';
import 'package:movieapp/movie/view/results_page.dart';
import 'package:movieapp/movie/view/search_page.dart';
            ...
            : AppBar(
                title: Padding(
                    padding: EdgeInsetsDirectional.only(
                        end: MediaQuery.of(context).size.width * 0.40),
                    child: Text("",
                        style: GoogleFonts.poppins(
                            color: AppColors.primaryColorDark, fontSize: 16))),
          ...
          child: BlocBuilder<MovieBloc, MovieState>(builder: (context, state) {
            if (state is CategoryScreen) {
              ...
              return Padding(
                padding: const EdgeInsets.only(right: 20, left: 20),
                child:
                    Expanded(child: ResultMoviePage(searchText: searchingText)),
              );
            }
            return Padding(
